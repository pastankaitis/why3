...
*/
public class DynamoDBTest1 {
	
	protected final static String AWSAccessKeyID = "AKIAJ7LGVJ2VMOG6ESUQ"; //"AKIAJ6CCAW5FIIWP3WZA";
	...
	*/
	...
	AWSCredentials credentials = new PropertiesCredentials(
			DynamoDBSequent.class.getResourceAsStream("AwsCredentials.properties"));
	dynamoDB = new AmazonDynamoDBClient(credentials);
	}*/

		public static void main(String[] args) throws Exception {
			try {
				System.out.println("[CHECK]-------> Authenticating.........!");
				
				//AWSCredentials credentials = new BasicAWSCredentials(AWSAccessKeyID, AWSSecretKey);
				ClientConfiguration clientConfig = new ClientConfiguration();
				clientConfig.setProtocol(Protocol.HTTP);
				
				dynamoDB = new AmazonDynamoDBClient(new BasicAWSCredentials(AWSAccessKeyID, AWSSecretKey), clientConfig);
				System.out.println("[CHECK]-------> Authenticated!");
				...
				.withKeySchema(new KeySchemaElement().withAttributeName("name").withAttributeName("S"))
