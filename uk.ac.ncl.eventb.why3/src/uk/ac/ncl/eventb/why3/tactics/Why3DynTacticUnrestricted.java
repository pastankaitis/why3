...
public class Why3DynTacticUnrestricted implements IUIDynTacticProvider {
	...
	public Collection<IUIDynTactic> getDynTactics(IProofTreeNode ptNode,
		...
		for(final String scen: Scenarios.SCENARIOS.keySet()) {
			final ITacticDescriptor desc = new ScenarioTacticDescriptor(false, scen, Why3Plugin.isCloud());
