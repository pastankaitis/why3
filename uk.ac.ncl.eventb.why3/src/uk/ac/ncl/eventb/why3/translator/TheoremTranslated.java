...
public class TheoremTranslated {
	...
	public TheoremTranslated getNegatedForm() {
		TheoremTranslated negated = new TheoremTranslated(types, definitions, hypothesis, "not (" + goal + ")");
		negated.setContext(getContext());
		negated.setImports(getImports());
		return negated;
	}
	...
	public String toString(IContextProvider provider) throws TranslationException {
